...
namespace EMS.API.Endpoints
{
    public static class RoleEndpoints
    {
        public static void Map(WebApplication app)
        {
            ...
            userGroup.MapPost("/{roleId:guid}/assign-permission", async (IRolePermissionService rolePermissionService, string roleId, string permissisonId) =>
            {
            ...
            userGroup.MapDelete("/{roleId:guid}/revoke-permission", async (IRolePermissionService rolePermissionService, string roleId, string permissisonId) =>
            {
                if (string.IsNullOrEmpty(permissisonId))
                    return Results.BadRequest("Permission ID is required.");
